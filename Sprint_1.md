PR-01: Базовая структура FastAPI и HealthCheck
...
PR-02: Изолированный модуль проверки таймзоны (Maintenance Guard)
...
PR-03: Изолированный модуль Rate Limiter (Token Bucket)
...
PR-04: Базовый HTTP-клиент StatCan (Интеграция Guard и Limiter)
...
PR-05: Pydantic схемы для метаданных StatCan
...
PR-06: Логика извлечения и нормализации данных StatCan
...
PR-07: Интерфейс облачного хранилища (S3 Manager)
...
PR-08: Инициализация Playwright Stealth (База для CMHC)
...
PR-09: Логика парсинга таблиц CMHC
