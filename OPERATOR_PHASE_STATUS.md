...
| 1.6 | Right-click Context Menus in Editor | ❌ Not shipped | — | No code fingerprint found in 2026-04-27 scan (zero hits for `ContextMenu`/`onContextMenu` under `frontend-public/src/components/editor`); no git log evidence; awaiting implementation. |
