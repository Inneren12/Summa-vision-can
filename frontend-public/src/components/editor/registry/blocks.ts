...
export const BREG: Record<string, BlockRegistryEntry> = {
  eyebrow_tag:{cat:"text",name:"Eyebrow",status:"optional_default",allowedSections:["header"],maxPerSection:1,dp:{text:"STATISTICS CANADA \u00B7 TABLE 18-10-0004"},cst:{maxChars:60,maxLines:1},ctrl:[{k:"text",i18nKey:"tag",t:"text",l:"Tag",ml:60}],
    guard:(p)=>typeof p.text==="string"},
  headline_editorial:{cat:"text",name:"Headline",status:"required_editable",allowedSections:["header"],maxPerSection:1,dp:{text:"Canadian Mortgage Rates\nHit 15-Year High",align:"left"},cst:{maxChars:80,maxLines:3},ctrl:[{k:"text",i18nKey:"headline",t:"textarea",l:"Headline",ml:80},{k:"align",t:"seg",l:"Align",opts:["left","center","right"]}],
    guard:(p)=>typeof p.text==="string"&&["left","center","right"].includes(p.align||"left")},
  subtitle_descriptor:{cat:"text",name:"Subtitle",status:"optional_default",allowedSections:["header","context"],maxPerSection:1,dp:{text:"Average 5-year fixed rate, March 2026"},cst:{maxChars:120,maxLines:2},ctrl:[{k:"text",i18nKey:"subtitle",t:"text",l:"Subtitle",ml:120}],
    guard:(p)=>typeof p.text==="string"},
  hero_stat:{cat:"data",name:"Hero Number",status:"required_editable",allowedSections:["hero"],maxPerSection:1,dp:{value:"6.73%",label:"5-year fixed rate"},cst:{maxChars:10},ctrl:[{k:"value",t:"text",l:"Value",ml:10},{k:"label",t:"text",l:"Label",ml:60}],
    ...
    acceptsBinding:["single"]},
  delta_badge:{cat:"data",name:"Delta Badge",status:"optional_default",allowedSections:["hero","context"],maxPerSection:1,dp:{value:"+247 bps since Jan 2022",direction:"negative"},cst:{maxChars:40},ctrl:[{k:"value",i18nKey:"delta",t:"text",l:"Delta",ml:40},{k:"direction",t:"seg",l:"Dir",labelKind:"short_label",opts:["positive","negative","neutral"]}],
    guard:(p)=>typeof p.value==="string"&&["positive","negative","neutral"].includes(p.direction||"neutral"),
    acceptsBinding:["single"]},
  body_annotation:{cat:"text",name:"Annotation",status:"optional_available",allowedSections:["context","chart"],maxPerSection:2,dp:{text:"Rates represent posted rates from chartered banks"},cst:{maxChars:200,maxLines:4},ctrl:[{k:"text",i18nKey:"note",t:"textarea",l:"Note",ml:200}],
    guard:(p)=>typeof p.text==="string"},
  source_footer:{cat:"text",name:"Source",status:"required_locked",allowedSections:["footer"],maxPerSection:1,dp:{text:"Source: Statistics Canada, Table 18-10-0004-01",methodology:""},cst:{maxChars:200},ctrl:[{k:"text",i18nKey:"source",t:"text",l:"Source",ml:200},{k:"methodology",i18nKey:"method",t:"text",l:"Method",labelKind:"short_label",ml:200}],
    guard:(p)=>typeof p.text==="string"},
  ...
  bar_horizontal:{cat:"chart",name:"Ranked Bars",status:"required_editable",allowedSections:["chart"],maxPerSection:1,
    ...
    ctrl:[{k:"unit",i18nKey:"unit_suffix",t:"text",l:"Unit suffix",ml:5},{k:"showBenchmark",i18nKey:"benchmark_line",t:"toggle",l:"Benchmark line"},{k:"benchmarkValue",i18nKey:"benchmark_value",t:"text",l:"Bench value",labelKind:"short_label",ml:10},{k:"benchmarkLabel",i18nKey:"benchmark_label",t:"text",l:"Bench label",labelKind:"short_label",ml:30}],
  ...
  line_editorial:{cat:"chart",name:"Line Chart",status:"required_editable",allowedSections:["chart"],maxPerSection:1,
    ...
    ctrl:[{k:"yUnit",i18nKey:"y_unit",t:"text",l:"Y unit",ml:5},{k:"showArea",i18nKey:"area_fill",t:"toggle",l:"Area fill"}],
  ...
  small_multiple:{cat:"chart",name:"Small Multiples",status:"required_editable",allowedSections:["chart"],maxPerSection:1,
    ...
    ctrl:[{k:"yUnit",i18nKey:"y_unit",t:"text",l:"Y unit",ml:5}],
