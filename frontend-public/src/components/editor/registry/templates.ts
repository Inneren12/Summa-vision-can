...
export const TPLS: Record<string, TemplateEntry> = {
  ...
  single_stat_minimal:{fam:"Single Stat Hero",vr:"Minimal",variantKey:"minimal",desc:"Clean, centered",descKey:"clean_centered",defaultPal:"neutral",defaultBg:"solid_dark",defaultSize:"twitter",sections:[{id:"header",type:"header",blockTypes:["headline_editorial"]},{id:"hero",type:"hero",blockTypes:["hero_stat"]},{id:"footer",type:"footer",blockTypes:["source_footer","brand_stamp"]}],overrides:{headline_editorial:{text:"Bank of Canada\nHolds Rates Steady",align:"center"},hero_stat:{value:"4.50%",label:"Overnight rate"},source_footer:{text:"Source: Bank of Canada"}}},
  ...
  visual_table:{fam:"Visual Table",vr:"Heatmap Rankings",variantKey:"heatmap_rankings",desc:"Table with conditional format",descKey:"table_with_conditional_format",defaultPal:"neutral",defaultBg:"solid_dark",defaultSize:"instagram_port",sections:[{id:"header",type:"header",blockTypes:["eyebrow_tag","headline_editorial"]},{id:"chart",type:"chart",blockTypes:["table_enriched"]},{id:"footer",type:"footer",blockTypes:["source_footer","brand_stamp"]}],overrides:{headline_editorial:{text:"The Best and Worst\nCountries for Taxes"},eyebrow_tag:{text:"RANKED: \u00B7 TAX COMPETITIVENESS \u00B7 2024"},source_footer:{text:"Source: Tax Foundation"}}},
