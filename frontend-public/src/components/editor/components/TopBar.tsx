...
export function TopBar({ doc, dispatch, undoStack, redoStack, dirty, mode, setMode, errs, warns, si, canExp, fileRef, importJSON, exportJSON, markSaved, exportPNG, saveStatus, fontsReady }: TopBarProps) {
