...
import type { CanonicalDocument, EditorAction } from '../types';
...
export function TopBar({ doc, dispatch, undoStack, redoStack, dirty, mode, setMode, errs, warns, si, canExp, fileRef, importJSON, exportJSON, saveDraft, exportPNG }: TopBarProps) {
  return (
