  ...
  return (
    <main className="min-h-screen px-4 py-12 max-w-4xl mx-auto">
      <article className="bg-card-bg rounded-public overflow-hidden shadow-card flex flex-col">
        <header className="p-8 border-b border-border-subtle">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-xs font-bold font-data px-2 py-1 rounded bg-bg-surface-hover text-text-primary">
          ...
          <h1 className="text-3xl font-bold font-display text-text-primary leading-tight mb-6">
            {graphic.headline}
          </h1>
        ...
        {graphic.cdn_url ? (
          <div className="relative w-full h-auto bg-bg-app/50 p-4 sm:p-8">
            <Image
              src={graphic.cdn_url}
              alt={graphic.headline}
              width={1200}
